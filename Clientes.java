...
public class Clientes extends LojaPrincipal{
    ...
    public Clientes(String nome, int cpf_cnpj, String logradouro, int numero,
                    String telefone, String cidade, String estado, String pais,
                    String email, int codigo, String senha) {
